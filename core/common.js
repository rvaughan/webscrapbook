...
scrapbook.options = {
  ...
  "capture.image": ["save", "link", "comment", "blank", "remove", 0],
  "capture.imageBackground": ["save", "link", "remove", 0],
  "capture.audio": ["save", "link", "comment", "blank", "remove", 0],
  "capture.video": ["save", "link", "comment", "blank", "remove", 0],
  "capture.embed": ["save", "link", "comment", "blank", "remove", 0],
  "capture.object": ["save", "link", "comment", "blank", "remove", 0],
  "capture.applet": ["save", "link", "comment", "blank", "remove", 0],
  "capture.canvas": ["save", "comment", "blank", "remove", 0],
  "capture.frame": ["save", "link", "comment", "blank", "remove", 0],
